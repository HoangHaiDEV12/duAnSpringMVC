...
<link rel="icon" type="image/x-icon"
	href="<c:url value='/template/admin/assets/img/favicon/favicon.ico'/>" />
...
<link rel="stylesheet"
	href="<c:url value='/template/admin/assets/vendor/fonts/boxicons.css'/>" />


<!-- Core CSS -->
<link rel="stylesheet"
	href="<c:url value='/template/admin/assets/vendor/css/core.css'/>"
	class="template-customizer-core-css" />

<link rel="stylesheet"
	href="<c:url value='/template/admin/assets/vendor/css/theme-default.css'/>"
...
<!-- Vendors CSS -->
<link rel="stylesheet"
	href="<c:url value='/template/admin/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css'/>" />

<!-- Page CSS -->
<!-- Page -->
<link rel="stylesheet"
	href="<c:url value='/template/admin/assets/vendor/css/pages/page-auth.css'/>" />
...
<link href="<c:url value='/template/home/css/style.css' /> "
	...
	<link href="<c:url value='/css/otp.css' /> "
	rel="stylesheet" />

<script src="<c:url value='/template/admin/assets/js/config.j' />"></script>
...
<body>
	...
	<script
		src="<c:url value='/template/admin/assets/vendor/js/menu.js' />"></script>
	...
	<script type="text/javascript"
		src="<c:url value='/js/countdown.js' /> "></script>
