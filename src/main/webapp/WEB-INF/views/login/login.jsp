			...
			<div class="card">
				<div class="card-body">
					...
					<div class="app-brand justify-content-center">
						<a href="/com.springweb/homepage" class="app-brand-link gap-2">
					...
					<form id="formAuthentication" class="mb-3" action="/com.springweb/login"
						method="post">
						<div class="mb-3">
						...
						<div class="mb-3 form-password-toggle">
							<div class="d-flex justify-content-between">
								<label class="form-label" for="password">Mật Khẩu</label> <a
									href="/com.springweb/recover"> <small>Quên
										Mật Khẩu?</small>
								</a>
							</div>
					...
					<p class="text-center">
						<span>Bạn Chưa Có Tài Khoản</span> <a href="/com.springweb/regist">
