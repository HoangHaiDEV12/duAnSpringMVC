			...
			<div class="card">
				<div class="card-body">
					...
					<div class="app-brand justify-content-center">
						<a href="/com.springweb/homepage" class="app-brand-link gap-2"> <span
					...
					<form id="formAuthentication" class="mb-3" action="/com.springweb/regist"
						method="POST">
						<div class="mb-3">
					...
					<p class="text-center">
						<span>Bạn Đã Có Tài Khoản?</span> <a
							href="/com.springweb/login"> <span>Đăng Nhập Tại Đây</span>
						</a>
					</p>
				</div>
			</div>
