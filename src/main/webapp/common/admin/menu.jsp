	...
	<ul class="menu-inner py-1">
		...
		<li class="menu-item"><a href="javascript:void(0)"
			class="menu-link menu-toggle"> <i
				...
				<div data-i18n="User interface">Quản trị người dùng</div>
		</a>
			<ul class="menu-sub">
				<li class="menu-item"><a href="/com.tulamweb/admin/account"
					class="menu-link">
						<div data-i18n="Accordion">Quản lí người dùng</div>
				</a></li>
		...
		<li class="menu-item"><a href="javascript:void(0)"
			class="menu-link menu-toggle"> <i
				...
				<div data-i18n="Extended UI">Quản lí loại sản phẩm</div>
		</a>
			<ul class="menu-sub">
				<li class="menu-item"><a href="/com.tulamweb/admin/category"
					class="menu-link">
						<div data-i18n="Perfect Scrollbar">Quản lí danh mục</div>
				</a></li>
				<li class="menu-item"><a href="/com.tulamweb/admin/subcategory"
					class="menu-link">
						<div data-i18n="Perfect Scrollbar">Quản lí loại sản phẩm</div>
				</a></li>
			</ul></li>
		...
		<li class="menu-item"><a href="javascript:void(0)"
			class="menu-link menu-toggle"> <i
				class="menu-icon tf-icons bx bx-copy"></i>
				<div data-i18n="Extended UI">Quản lý sản phẩm</div>
		</a>
			<ul class="menu-sub">
				<li class="menu-item"><a href="/com.tulamweb/admin/product"
					class="menu-link">
						<div data-i18n="Perfect Scrollbar">Quản lí sản phẩm</div>
				</a></li>
				 <li class="menu-item"><a href="/com.tulamweb/admin/size"
					class="menu-link">
						<div data-i18n="Perfect Scrollbar">Quản lí size</div>
				</a></li> 
			</ul></li>
